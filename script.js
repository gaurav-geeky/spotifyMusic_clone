...
async function main() {
    ...
    previous.addEventListener("click", () => {
        ...
        let index = songs.indexOf(currentSong.src.split("/").slice(-1)[0]); // error instru cs
        if ((index - 1) >= 0) {
    ...
    next.addEventListener("click", () => {
        ...
        let index = songs.indexOf(currentSong.src.split("/").slice(-1)[0]); // error
